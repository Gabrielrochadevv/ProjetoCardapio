...
checkoutBtn.addEventListener("click", function () {
    ...
    const phone = "17997059486"

    window.open(`https://wa.me/${phone}?text=${message} Endereco: ${adressInput.value}`, "_blanck")

    cart = [];
    updateCartModal;
})

// Vereficar a hora e manipular o card horário
function checkRestaurantOpen() {
    const data = new Date();
    const hora = data.getHours();
    return hora >= 18 && hora < 22;
    //true = resturante aberto
